...
$(function() {
  ...
  var menuTrigger        = $('#menu-trigger'),
	  ...
	  faqsTrigger       = $('#faqs-trigger'),
	  submissionTrigger  = $('#submission-trigger'),
  ...
  // rules section open
  rulesTrigger.on('click', function(event) {
    event.preventDefault();
    setTimeout(function(){
	  rulesSection.addClass('active animate-in');
      rulesTrigger.addClass('active-link');
    }, 500);
  });

    // faqs section open
	faqsTrigger.on('click', function(event) {
		event.preventDefault();
		setTimeout(function(){
			faqsSection.addClass('active animate-in');
		  faqsTrigger.addClass('active-link');
		}, 500);
	  });

 // submission section open
 submissionTrigger.on('click', function(event) {
	event.preventDefault();
	setTimeout(function(){
		submissionSection.addClass('active animate-in');
		submissionTrigger.addClass('active-link');
	}, 500);
  });
